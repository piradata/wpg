...
if __name__ == '__main__':
	try:
		...
		while(True):
			...
			if event == 'SEND_YAW':
				try:
					setpoint.yaw_degrees = int(values["YAW"])
				except ValueError:
			...
			if not event == u'__TIMEOUT__':
				...
				if not _x == None:
					...
					# print("poo")
					setpoint.set(_X_SIZE * _x / 400.0, _Y_SIZE * _y / 400.0, setpoint.z, 0)
		...
		setpoint.set(0.0, 0.0, 2.0, 0)
		setpoint.set(0.0, 0.0, 1.0, 0)
		setpoint.set(0.0, 0.0, 0.0, 0)
		setpoint.set(0.0, 0.0, -0.2, 0)
